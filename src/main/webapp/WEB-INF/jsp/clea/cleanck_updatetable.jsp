...
<head>
    ...
    <script src="${pageContext.request.contextPath }/statics/js/forCleanck_updatetable.js" type="text/javascript"/>
...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <form id="updateCleanCheckForm" method="post" action="">
        <input type="hidden" id="theCleanCheckId" value="${theCleanCheckId}">
        <table style="margin:10px auto;">
            ...
            <tr>
                <td><span>清洁人：</span><input type="text" id="cleanck_cleaner" placeholder="必填" class="intext" required/><span id="checkTheCleanCheckCleaner"></span></td>
                <td><span>检查人：</span><input type="text" id="cleanck_rummager" placeholder="必填" class="intext" required><span id="checkTheCleanCheckRummager"></span></td>
            </tr>
            <tr>
                <td><span>检查情况：</span><input type="text" id="cleanck_situation" placeholder="必填" class="intext" required><span id="checkTheCleanCheckSituation"></span></td>
            </tr>
            <tr >
                <td>
                    <span >备注：</span>
            ...
            <tr>
                <td colspan="2" align="center" style="height: 30px;color: black;">
                    <input type="button" id="updateCleanCheck" name="submit" value=" 保存并更改 " style="color:black;"/>
