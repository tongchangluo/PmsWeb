...
<head>
	...
	<script src="${pageContext.request.contextPath }/statics/js/forCleanck_addtable.js" type="text/javascript"/>
        	...
        	<table style="margin:10px auto;">
        		...
        		<tr>
        			<td colspan="2" align="center" style="height: 30px;color: black;">
                        <input type="button" id="addCleanCheck" name="submit" value=" 保存并添加 " style="color:black;"/>
