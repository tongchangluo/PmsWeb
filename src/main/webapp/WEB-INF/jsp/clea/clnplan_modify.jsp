...
<body class="gray-bg">
    <div class="wrapper wrapper-content animated fadeInRight">
        ...
        <form  method="post" action="${cxt }/clnplan/clnplanModify.html" name="clnplanSubmit" >
        	<table style="margin:10px auto;">
				               ...
				               <c:forEach var="ldc" varStatus="i" items="${ldcompanys}">
				               		<c:choose>
				               			<c:when test="${plan.landdevCompany.ldcId==ldc.ldcId}">
				               				 <option value="${plan.landdevCompany.ldcId}" selected>${plan.landdevCompany.ldcName}</option>
				               			</c:when>
				               			<c:otherwise>
        		...
        		<tr>
        			<td style="text-align:center;" colspan="4">
        				<input type="hidden" name="clnplan_id" value="${plan.clnplan_id }" />
