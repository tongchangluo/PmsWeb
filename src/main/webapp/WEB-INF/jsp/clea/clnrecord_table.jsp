...
<body class="gray-bg">
    <div class="wrapper wrapper-content animated fadeInRight">
        ...
        <form  method="post" action="${cxt }/clnrecord/addClnrecord.html" name="clnplanSubmit" >
        	<table style="margin:10px auto;">
        		...
        		<tr>
        			...
        			<td colspan="3">
	        			<input name="clnplan_place" id="planPlace" placeholder="根据所选项目带出" type="text" class="intext" style="width:782px" value="" readonly="readonly"/>
	        			<span style="color:red;"></span>
        			</td>
        		</tr>
        		<tr>
        			...
        			<td>
	        			<input name="clnplan_charge" id="planCharge" placeholder="根据所选项目带出" type="text" class="intext" value="" readonly="readonly"/>
	        			<span style="color:red;"></span>
        			</td>
        		</tr>
        		<tr>
        			...
        			<td>
	        			<input name="clnrecord_cleaner" id="recordCleaner" placeholder="请输入" type="text" class="intext" value="" />
	        			<span style="color:red;"></span>
        			</td>
        			<td style="text-align:right;"><span>清洁时间：</span></td>
        			<td>
	        			<input id="pDate" name="clnrecord_date" class="Wdate" onFocus="WdatePicker({lang:'zh-cn'})" style="width: 250px;height:30px;"/>
	        			<span style="color:red;"></span>
        			</td>
        		</tr>
        		<tr >
        			...
        			<td colspan="3">
        				<input name="clnrecord_situation" id="recordSummary" placeholder="请输入"  type="text" class="intext"  style="width:782px" value="" />
        				<span style="color:red;"></span>
        			</td>
        		</tr>
        		<tr >
        			...
        			<td colspan="3">
        				<textarea  name="clnrecord_remark" id="recordRemark" cols="900" rows="3" class="intext" style="width:782px"></textarea>
        				<span style="color:red;"></span>
        			</td>
        		</tr>
        		<tr>
