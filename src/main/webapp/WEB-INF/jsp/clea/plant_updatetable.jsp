...
<sc>
    ...
    <script src="${pageContext.request.contextPath }/statics/js/forPlant_updatetable.js" type="text/javascript"></script>
...
<div class="wrapper wrapper-content animated fadeInRight">
    <h2 style="text-align:center; color: black; margin-top: 10px;">修改植被信息</h2>
    <form id="addPlantForm" method="post" action="">
        <input id="thePlantId" type="hidden" value=${thePlantId} />
        <table style="margin:10px auto;">
            ...
            <tr>
                <td colspan="2" align="center" style="height: 30px;" style="color: black;">
                    <input type="button" id="updatePlant" name="submit" value=" 保存并更改 " style="color:black;"/>
