...
<head>
    ...
    <link href="${pageContext.request.contextPath }/static/css/VOStyle/VOStyle.css" rel="stylesheet"/>
</head>
<body class="fixed-sidebar full-height-layout gray-bg" style="overflow:hidden">
                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <span><img alt="image" class="img-circle" src="${pageContext.request.contextPath }/static/img/profile_small.jpg" id="head" height="80" /></span>
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                               <span class="block m-t-xs"><strong class="font-bold">物业管理系统</strong></span>
                                <span class="text-muted text-xs block" id="user_name">系统管理员<!--<b class="caret"></b>--></span>
                                </span>
                            </a>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li><a class="J_menuItem" href="bldproperty.jsp">楼盘属性维护</a></li>
                            <li><a class="J_menuItem" href="plant.jsp">植被信息</a></li>
                            <li><a class="J_menuItem" href="plantset.jsp">绿化设置</a></li>
                            <li><a class="J_menuItem" href="plantck.jsp">绿化检查</a></li>
                            <li><a class="J_menuItem" href="clnplan.jsp">清洁安排</a></li>
                            <li><a class="J_menuItem" href="clnrecord.jsp">清洁记录</a></li>
                            <li><a class="J_menuItem" href="cleanck.jsp">清洁检查</a></li>
                        </ul>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row border-bottom">
                <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                    <h2 class ="navbar-top-titile">欢迎你!<span class="navbar-usr">&nbsp;物业系统管理员</span></h2>
                   <h2 class="navbar-top-time" id="clock">2018年04月09日 10:19:40 星期四</h2>
                </nav>
            </div>
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="welcome.jsp" frameborder="0" data-id="index_v1.jsp" seamless></iframe>
            </div>
    ...
    <script type="text/javascript">
    	...
    	function aftersuccess(data){
    		$("#head").attr("src","/ViOrder/"+data.headPortaist);
    		$("#user_name").jsp(data.userName)
    	}
    	function check(i) {
              if(i<10){
                  i="0"+i;
          ...
          function clock() {
              ...
              month=check(month+1);
              document.getElementById("clock").innerHTML=year+"年"+month+"月"+day+"日"+" "+hour+":"+minutes+":"+seconds+" "+week[m];
          }
