...
<head>
	...
	<script src="${pageContext.request.contextPath }/statics/js/forPlant_addtable.js" type="text/javascript"/>
        ...
        <form id="addPlantForm" method="post" action="">
        	<table style="margin:10px auto;">
        		...
        		<tr>
        			...
        			<td><span>植物树龄：</span><input type="number" id="plant_age" placeholder="必填" class="intext" min="0" max="999" required/><span id="checkThePlantAge" style="color:red;"></span></td>
        		</tr>
        		<tr>
					<td><span>植物数量：</span><input type="number" id="plant_quantity" placeholder="必填" class="intext" min="0" max="999" required/><span id="checkThePlantQuantity" style="color:red;"></span></td>
					<td><span>植物单位</span><input type="text" id="plant_unit" placeholder="必填，如棵" class="intext" required/><span id="checkThePlantUnit" style="color:red;"></span></td>
				</tr>
				<tr>
        		...
        		<tr>
        			<td colspan="2" align="center" style="height: 30px;" style="color: black;">
                        <input type="button" id="addPlant" name="submit" value=" 保存并添加 " style="color:black;"/>
