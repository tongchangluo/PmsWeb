...
<head>
    ...
    <link href="${cxt}/statics/css/bootstrap.min14ed.css?v=3.3.6" rel="stylesheet">
...
<body class="fixed-sidebar full-height-layout gray-bg" style="overflow:hidden">
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <span><img alt="image" class="img-circle" src="${cxt}/statics/img/profile_small.jpg" /></span>
                   ...
                   <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="404.html">业主信息</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="owner/checkpro.jsp">业主验房</a>
                            </li>
                            <li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                             <li>
                            	<a class="J_menuItem" href="${cxt }/bldProperty/bldproperty.html">楼盘属性维护</a>
                             </li>
                             <li>
                            	<a class="J_menuItem" href="${cxt }/plant">植被信息</a>
                             </li>
                             <li>
                            	<a class="J_menuItem" href="${cxt }/psList.action">绿化设置</a>
                             </li>
                             <li>
                            	<a class="J_menuItem" href="${cxt }/pcList.action">绿化检查</a>
                             </li>
                             <li>
                            	<a class="J_menuItem" href="${cxt}/clnplan/clnplanList.html">清洁安排</a>
                             </li>
                             <li>
                            	<a class="J_menuItem" href="${cxt}/clnrecord/recordList.html">清洁记录</a>
                             </li>
                             <li>
                            	<a class="J_menuItem" href="${cxt }/cleanck">清洁检查</a>
                             </li>
                        </ul>
                    </li>
                    <li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-messages">
                                <li class="m-t-xs">
                                    <div class="dropdown-messages-box">
                                        <a href="profile.html" class="pull-left">
                                            <img alt="image" class="img-circle" src="${cxt}/statics/img/a7.jpg">
                                        </a>
                                ...
                                <li>
                                    <div class="dropdown-messages-box">
                                        <a href="profile.html" class="pull-left">
                                            <img alt="image" class="img-circle" src="${cxt}/statics/img/a4.jpg">
                                        </a>
                                        <div class="media-body ">
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="${cxt}/WEB-INF/jsp/index_v148b2.html" frameborder="0" data-id="index_v1.html" seamless></iframe>
            </div>
            <div class="footer">
                    ...
                    <div id="tab-2" class="tab-pane">
                        ...
                        <div>
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="${cxt}/statics/img/a1.jpg">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="${cxt}/statics/img/a2.jpg">
                                    </div>
                                    <div class="media-body">
                                        北大青鸟 绿地中央广场综合物业办公系统
                                        <br>
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="${cxt}/statics/img/a3.jpg">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="${cxt}/statics/img/a4.jpg">
                                    </div>
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="${cxt}/statics/img/a8.jpg">
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="${cxt}/statics/img/a7.jpg">
                                    </div>
                                    <div class="media-body">
    ...
    <script src="${cxt}/statics/js/plugins/metisMenu/jquery.metisMenu.js"></script>
    <script src="${cxt}/statics/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>
    <script src="${cxt}/statics/js/plugins/layer/layer.min.js"></script>
    <script src="${cxt}/statics/js/hplus.min.js?v=4.1.0"></script>
    <script type="text/javascript" src="${cxt}/statics/js/contabs.min.js"></script>
    <script src="${cxt}/statics/js/plugins/pace/pace.min.js"></script>
</body>
</html>
